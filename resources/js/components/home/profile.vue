                    ...
                    <div class="col-md-12">
                        ...
                        <div class="profile-basic">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group bg-hover form-focus select-focus focused">
                                        <label class="focus-label">Gendar</label>
                                        <select class="select form-control floating select2-hidden-accessible"
                                            data-select2-id="select2-data-4-xd6h" tabindex="-1" aria-hidden="true">
                                            <option value="male selected" data-select2-id="select2-data-6-ifqy">Male
                                            </option>
